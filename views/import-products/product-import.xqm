...
declare %plugin:provide('side-navigation')
  ...
  <li xmlns="http://www.w3.org/1999/xhtml" data-parent="/admin" data-sortkey="M">
      <a href="{$global:servlet-prefix}/admin/sanofi/import-products"><i class="fa fa-upload"></i> <span data-i18n="side-navigation-import-products" class="nav-label">Produktimport</span></a>
  </li>
};

declare %plugin:provide("ui/page/content","sanofi/import-products")
...
declare %plugin:provide("ui/page/custom-js","sanofi/import-products")
...
declare %plugin:provide("ui/page/footer","sanofi/import-products") 
