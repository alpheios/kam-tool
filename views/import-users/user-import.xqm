...
declare %plugin:provide('side-navigation')
  ...
  <li xmlns="http://www.w3.org/1999/xhtml" data-parent="/admin" data-sortkey="M">
      <a href="{$global:servlet-prefix}/admin/sanofi/import-users"><i class="fa fa-download"></i> <span data-i18n="side-navigation-import-users" class="nav-label">Produktimport</span></a>
  </li>
};
