...
declare %plugin:provide('side-navigation-item')
  ...
  <li xmlns="http://www.w3.org/1999/xhtml" data-parent="/admin" data-sortkey="M">
      <a href="{$global:servlet-prefix}/admin/api/page?provider={$_:ns}"><i class="fa fa-upload"></i> <span data-i18n="side-navigation-import-regelungen" class="nav-label">Regelungen Import</span></a>
  </li>
};
